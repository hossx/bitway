...
class ThriftBinarySerializer extends Serializer {
  ...
  lazy val _cAccountExchange = BinaryScalaCodec(AccountExchange)
  ...
  lazy val _cBankAccount = BinaryScalaCodec(BankAccount)
  lazy val _cBillItem = BinaryScalaCodec(BillItem)
  lazy val _cBitcoinBlock = BinaryScalaCodec(BitcoinBlock)
  lazy val _cBitcoinTx = BinaryScalaCodec(BitcoinTx)
  lazy val _cBitcoinTxPort = BinaryScalaCodec(BitcoinTxPort)
  lazy val _cBlockIndex = BinaryScalaCodec(BlockIndex)
  lazy val _cCashAccount = BinaryScalaCodec(CashAccount)
  lazy val _cContact = BinaryScalaCodec(Contact)
  ...
  lazy val _cDelayedPost = BinaryScalaCodec(DelayedPost)
  lazy val _cDepth = BinaryScalaCodec(Depth)
  lazy val _cDepthItem = BinaryScalaCodec(DepthItem)
  lazy val _cExchangeAccountInfo = BinaryScalaCodec(ExchangeAccountInfo)
  lazy val _cExchangeOrder = BinaryScalaCodec(ExchangeOrder)
  lazy val _cExchangeParam = BinaryScalaCodec(ExchangeParam)
  lazy val _cExchangeRate = BinaryScalaCodec(ExchangeRate)
  lazy val _cFee = BinaryScalaCodec(Fee)
  lazy val _cGetAccountResult = BinaryScalaCodec(GetAccountResult)
  lazy val _cInvoice = BinaryScalaCodec(Invoice)
  lazy val _cInvoiceData = BinaryScalaCodec(InvoiceData)
  lazy val _cInvoiceNotification = BinaryScalaCodec(InvoiceNotification)
  lazy val _cInvoiceNotificationInfo = BinaryScalaCodec(InvoiceNotificationInfo)
  lazy val _cInvoiceSummary = BinaryScalaCodec(InvoiceSummary)
  lazy val _cInvoiceUpdate = BinaryScalaCodec(InvoiceUpdate)
  lazy val _cL2MarketExchangeOrder = BinaryScalaCodec(L2MarketExchangeOrder)
  lazy val _cMerchant = BinaryScalaCodec(Merchant)
  lazy val _cNotificationData = BinaryScalaCodec(NotificationData)
  lazy val _cOrder = BinaryScalaCodec(Order)
  lazy val _cOrderUpdate = BinaryScalaCodec(OrderUpdate)
  lazy val _cPaymentData = BinaryScalaCodec(PaymentData)
  lazy val _cPaymentNotification = BinaryScalaCodec(PaymentNotification)
  lazy val _cQuantAccount = BinaryScalaCodec(QuantAccount)
  ...
  lazy val _cSellParam = BinaryScalaCodec(SellParam)
  lazy val _cSpanCursor = BinaryScalaCodec(SpanCursor)
  lazy val _cSubmitOrderResult = BinaryScalaCodec(SubmitOrderResult)
  lazy val _cTAddressStatus = BinaryScalaCodec(TAddressStatus)
  lazy val _cTradeAction = BinaryScalaCodec(TradeAction)
  lazy val _cTradePair = BinaryScalaCodec(TradePair)
  lazy val _cTradeStrategy = BinaryScalaCodec(TradeStrategy)
  lazy val _cTransferConfig = BinaryScalaCodec(TransferConfig)
  lazy val _cAccessDenied = BinaryScalaCodec(AccessDenied)
  lazy val _cAccessGranted = BinaryScalaCodec(AccessGranted)
  lazy val _cAccountDisabled = BinaryScalaCodec(AccountDisabled)
  ...
  lazy val _cAdjustAggregationAccount = BinaryScalaCodec(AdjustAggregationAccount)
  lazy val _cAdjustAggregationAccountResult = BinaryScalaCodec(AdjustAggregationAccountResult)
  lazy val _cAdjustMerchantAccount = BinaryScalaCodec(AdjustMerchantAccount)
  lazy val _cAdjustMerchantAccountResult = BinaryScalaCodec(AdjustMerchantAccountResult)
  ...
  lazy val _cAdminSetTransferStatus = BinaryScalaCodec(AdminSetTransferStatus)
  lazy val _cAllApiTokensDestroied = BinaryScalaCodec(AllApiTokensDestroied)
  ...
  lazy val _cApiTokenCreated = BinaryScalaCodec(ApiTokenCreated)
  lazy val _cApiTokenDestroied = BinaryScalaCodec(ApiTokenDestroied)
  lazy val _cApiTokenNotExist = BinaryScalaCodec(ApiTokenNotExist)
  lazy val _cBestAskRates = BinaryScalaCodec(BestAskRates)
  lazy val _cBestBidRates = BinaryScalaCodec(BestBidRates)
  lazy val _cBestBtcRatesUpdated = BinaryScalaCodec(BestBtcRatesUpdated)
  lazy val _cBitcoinBlockSeen = BinaryScalaCodec(BitcoinBlockSeen)
  lazy val _cBitcoinSold = BinaryScalaCodec(BitcoinSold)
  lazy val _cBitcoinTxSeen = BinaryScalaCodec(BitcoinTxSeen)
  lazy val _cBitwayMessage = BinaryScalaCodec(BitwayMessage)
  lazy val _cBitwayRequest = BinaryScalaCodec(BitwayRequest)
  lazy val _cBitwayTransferRequest = BinaryScalaCodec(BitwayTransferRequest)
  lazy val _cBuyBTC = BinaryScalaCodec(BuyBTC)
  lazy val _cBuyBitcoinAtL2Market = BinaryScalaCodec(BuyBitcoinAtL2Market)
  lazy val _cCancelExchangeOrder = BinaryScalaCodec(CancelExchangeOrder)
  lazy val _cCancelExchangeOrderResult = BinaryScalaCodec(CancelExchangeOrderResult)
  lazy val _cCleanBlockChain = BinaryScalaCodec(CleanBlockChain)
  lazy val _cCreateAccount = BinaryScalaCodec(CreateAccount)
  lazy val _cCreateAccountResult = BinaryScalaCodec(CreateAccountResult)
  lazy val _cCreateApiToken = BinaryScalaCodec(CreateApiToken)
  lazy val _cCreateDepthMakerStrategy = BinaryScalaCodec(CreateDepthMakerStrategy)
  lazy val _cCreateInvoice = BinaryScalaCodec(CreateInvoice)
  lazy val _cCreateSimpleExchangeStrategy = BinaryScalaCodec(CreateSimpleExchangeStrategy)
  ...
  lazy val _cCurrentExchangeRateResult = BinaryScalaCodec(CurrentExchangeRateResult)
  lazy val _cDepthUpdated = BinaryScalaCodec(DepthUpdated)
  lazy val _cDestoryAllApiTokens = BinaryScalaCodec(DestoryAllApiTokens)
  lazy val _cDestoryApiToken = BinaryScalaCodec(DestoryApiToken)
  lazy val _cDisableAccount = BinaryScalaCodec(DisableAccount)
  lazy val _cDoCancelSettle = BinaryScalaCodec(DoCancelSettle)
  lazy val _cDoCancelTransfer = BinaryScalaCodec(DoCancelTransfer)
  lazy val _cDoLogin = BinaryScalaCodec(DoLogin)
  lazy val _cDoPaymentRequest = BinaryScalaCodec(DoPaymentRequest)
  lazy val _cDoRegister = BinaryScalaCodec(DoRegister)
  ...
  lazy val _cDoSendCoin = BinaryScalaCodec(DoSendCoin)
  lazy val _cDoSendEmail = BinaryScalaCodec(DoSendEmail)
  lazy val _cDoSetMerchantStatus = BinaryScalaCodec(DoSetMerchantStatus)
  lazy val _cDoUpdateMerchant = BinaryScalaCodec(DoUpdateMerchant)
  lazy val _cDoUpdateMerchantFee = BinaryScalaCodec(DoUpdateMerchantFee)
  lazy val _cDoValidateRegister = BinaryScalaCodec(DoValidateRegister)
  lazy val _cDumpStateToFile = BinaryScalaCodec(DumpStateToFile)
  lazy val _cFetchAddresses = BinaryScalaCodec(FetchAddresses)
  lazy val _cFetchDepth = BinaryScalaCodec(FetchDepth)
  ...
  lazy val _cGetAllOpeningOrders = BinaryScalaCodec(GetAllOpeningOrders)
  lazy val _cGetAllOpeningOrdersResult = BinaryScalaCodec(GetAllOpeningOrdersResult)
  lazy val _cGetAssets = BinaryScalaCodec(GetAssets)
  lazy val _cGetAssetsResult = BinaryScalaCodec(GetAssetsResult)
  lazy val _cGetBestAskRates = BinaryScalaCodec(GetBestAskRates)
  lazy val _cGetBestBidRates = BinaryScalaCodec(GetBestBidRates)
  lazy val _cGetCurrentExchangeRate = BinaryScalaCodec(GetCurrentExchangeRate)
  lazy val _cGetDepth = BinaryScalaCodec(GetDepth)
  lazy val _cGetDepthResult = BinaryScalaCodec(GetDepthResult)
  lazy val _cGetDepths = BinaryScalaCodec(GetDepths)
  lazy val _cGetDepthsResult = BinaryScalaCodec(GetDepthsResult)
  lazy val _cGetExchangeHealth = BinaryScalaCodec(GetExchangeHealth)
  lazy val _cGetExchangeHealthResult = BinaryScalaCodec(GetExchangeHealthResult)
  lazy val _cGetMissedCryptoCurrencyBlocks = BinaryScalaCodec(GetMissedCryptoCurrencyBlocks)
  lazy val _cGetPlatformBalances = BinaryScalaCodec(GetPlatformBalances)
  lazy val _cInvoiceComplete = BinaryScalaCodec(InvoiceComplete)
  lazy val _cInvoiceCreated = BinaryScalaCodec(InvoiceCreated)
  lazy val _cInvoiceCreationFailed = BinaryScalaCodec(InvoiceCreationFailed)
  lazy val _cInvoiceDebugRequest = BinaryScalaCodec(InvoiceDebugRequest)
  lazy val _cInvoicePartialUpdate = BinaryScalaCodec(InvoicePartialUpdate)
  lazy val _cInvoiceStatusChanged = BinaryScalaCodec(InvoiceStatusChanged)
  lazy val _cInvoiceUpdated = BinaryScalaCodec(InvoiceUpdated)
  lazy val _cListenAtRedis = BinaryScalaCodec(ListenAtRedis)
  lazy val _cLockAccountRequest = BinaryScalaCodec(LockAccountRequest)
  lazy val _cLockAccountResult = BinaryScalaCodec(LockAccountResult)
  lazy val _cLockCoinRequest = BinaryScalaCodec(LockCoinRequest)
  lazy val _cLockCoinResult = BinaryScalaCodec(LockCoinResult)
  lazy val _cLoginFailed = BinaryScalaCodec(LoginFailed)
  lazy val _cLoginSucceeded = BinaryScalaCodec(LoginSucceeded)
  lazy val _cMarketDataUpdated = BinaryScalaCodec(MarketDataUpdated)
  lazy val _cMerchantBalanceRequest = BinaryScalaCodec(MerchantBalanceRequest)
  lazy val _cMerchantBalanceResult = BinaryScalaCodec(MerchantBalanceResult)
  lazy val _cMerchantRefund = BinaryScalaCodec(MerchantRefund)
  lazy val _cMerchantSettle = BinaryScalaCodec(MerchantSettle)
  lazy val _cMessageNotSupported = BinaryScalaCodec(MessageNotSupported)
  lazy val _cMigrateSecretKey = BinaryScalaCodec(MigrateSecretKey)
  ...
  lazy val _cNotifyMerchants = BinaryScalaCodec(NotifyMerchants)
  lazy val _cNotifyPayments = BinaryScalaCodec(NotifyPayments)
  lazy val _cOpeningOrdersReceived = BinaryScalaCodec(OpeningOrdersReceived)
  lazy val _cOrderLogisticsUpdated = BinaryScalaCodec(OrderLogisticsUpdated)
  lazy val _cOrderLogisticsUpdatedResult = BinaryScalaCodec(OrderLogisticsUpdatedResult)
  lazy val _cPaymentMessage = BinaryScalaCodec(PaymentMessage)
  lazy val _cPaymentReceived = BinaryScalaCodec(PaymentReceived)
  lazy val _cPingFeProxy = BinaryScalaCodec(PingFeProxy)
  lazy val _cPlatformBalanceUpdated = BinaryScalaCodec(PlatformBalanceUpdated)
  lazy val _cQuantMessage = BinaryScalaCodec(QuantMessage)
  lazy val _cQueryAccount = BinaryScalaCodec(QueryAccount)
  lazy val _cQueryAccountResult = BinaryScalaCodec(QueryAccountResult)
  lazy val _cQueryAccountsById = BinaryScalaCodec(QueryAccountsById)
  lazy val _cQueryAccountsByIdResult = BinaryScalaCodec(QueryAccountsByIdResult)
  lazy val _cQueryAggregateAssets = BinaryScalaCodec(QueryAggregateAssets)
  lazy val _cQueryAggregateAssetsResult = BinaryScalaCodec(QueryAggregateAssetsResult)
  lazy val _cQueryAllChangeRate = BinaryScalaCodec(QueryAllChangeRate)
  lazy val _cQueryAllChangeRateResult = BinaryScalaCodec(QueryAllChangeRateResult)
  lazy val _cQueryAsset = BinaryScalaCodec(QueryAsset)
  lazy val _cQueryAssetResult = BinaryScalaCodec(QueryAssetResult)
  lazy val _cQueryBill = BinaryScalaCodec(QueryBill)
  lazy val _cQueryBillResult = BinaryScalaCodec(QueryBillResult)
  lazy val _cQueryBlockChainAmount = BinaryScalaCodec(QueryBlockChainAmount)
  lazy val _cQueryBlockChainAmountResult = BinaryScalaCodec(QueryBlockChainAmountResult)
  lazy val _cQueryChangeRate = BinaryScalaCodec(QueryChangeRate)
  lazy val _cQueryChangeRateResult = BinaryScalaCodec(QueryChangeRateResult)
  lazy val _cQueryInvoice = BinaryScalaCodec(QueryInvoice)
  lazy val _cQueryInvoiceById = BinaryScalaCodec(QueryInvoiceById)
  lazy val _cQueryInvoiceByIds = BinaryScalaCodec(QueryInvoiceByIds)
  lazy val _cQueryInvoiceResult = BinaryScalaCodec(QueryInvoiceResult)
  lazy val _cQueryMerchantBalance = BinaryScalaCodec(QueryMerchantBalance)
  lazy val _cQueryMerchantBalanceResult = BinaryScalaCodec(QueryMerchantBalanceResult)
  lazy val _cQueryMerchantById = BinaryScalaCodec(QueryMerchantById)
  lazy val _cQueryMerchantResult = BinaryScalaCodec(QueryMerchantResult)
  lazy val _cQueryMerchants = BinaryScalaCodec(QueryMerchants)
  lazy val _cQueryMerchantsResult = BinaryScalaCodec(QueryMerchantsResult)
  lazy val _cQueryOrderStatus = BinaryScalaCodec(QueryOrderStatus)
  lazy val _cQueryOrderStatusResult = BinaryScalaCodec(QueryOrderStatusResult)
  lazy val _cQueryRecoverStats = BinaryScalaCodec(QueryRecoverStats)
  lazy val _cQuerySnapshots = BinaryScalaCodec(QuerySnapshots)
  lazy val _cQuerySnapshotsResult = BinaryScalaCodec(QuerySnapshotsResult)
  ...
  lazy val _cRegisterFailed = BinaryScalaCodec(RegisterFailed)
  lazy val _cRegisterSucceeded = BinaryScalaCodec(RegisterSucceeded)
  ...
  lazy val _cResendFailed = BinaryScalaCodec(ResendFailed)
  lazy val _cResendNotify = BinaryScalaCodec(ResendNotify)
  lazy val _cResendSuccessed = BinaryScalaCodec(ResendSuccessed)
  ...
  lazy val _cSecretKeyUpdated = BinaryScalaCodec(SecretKeyUpdated)
  lazy val _cSellBTC = BinaryScalaCodec(SellBTC)
  lazy val _cSellBitcoin = BinaryScalaCodec(SellBitcoin)
  lazy val _cSellBitcoinAtL2Market = BinaryScalaCodec(SellBitcoinAtL2Market)
  lazy val _cSendRawTransaction = BinaryScalaCodec(SendRawTransaction)
  lazy val _cSendRawTransactionResult = BinaryScalaCodec(SendRawTransactionResult)
  lazy val _cSendVerificationMail = BinaryScalaCodec(SendVerificationMail)
  lazy val _cSendVerificationMailSucceeded = BinaryScalaCodec(SendVerificationMailSucceeded)
  lazy val _cSetMerchantStatusResult = BinaryScalaCodec(SetMerchantStatusResult)
  lazy val _cSubmitExchangeOrder = BinaryScalaCodec(SubmitExchangeOrder)
  lazy val _cSubmitExchangeOrderResult = BinaryScalaCodec(SubmitExchangeOrderResult)
  lazy val _cSubmitTradeAction = BinaryScalaCodec(SubmitTradeAction)
  lazy val _cSubmitTradeActionResult = BinaryScalaCodec(SubmitTradeActionResult)
  lazy val _cSubmittedOrders = BinaryScalaCodec(SubmittedOrders)
  lazy val _cSyncDepth = BinaryScalaCodec(SyncDepth)
  ...
  lazy val _cTryFetchAddresses = BinaryScalaCodec(TryFetchAddresses)
  lazy val _cTrySyncHotAddresses = BinaryScalaCodec(TrySyncHotAddresses)
  lazy val _cUnlockCoinRequest = BinaryScalaCodec(UnlockCoinRequest)
  lazy val _cUpdateAccount = BinaryScalaCodec(UpdateAccount)
  lazy val _cUpdateAccountResult = BinaryScalaCodec(UpdateAccountResult)
  lazy val _cUpdateMerchantFailed = BinaryScalaCodec(UpdateMerchantFailed)
  lazy val _cUpdateMerchantSucceeded = BinaryScalaCodec(UpdateMerchantSucceeded)
  lazy val _cUpdateSecretKey = BinaryScalaCodec(UpdateSecretKey)
  lazy val _cValidateRegisterFailed = BinaryScalaCodec(ValidateRegisterFailed)
  lazy val _cValidateRegisterSucceeded = BinaryScalaCodec(ValidateRegisterSucceeded)
  lazy val _cValidateToken = BinaryScalaCodec(ValidateToken)
  lazy val _cWatchInvoiceStatus = BinaryScalaCodec(WatchInvoiceStatus)
  lazy val _cTAccountState = BinaryScalaCodec(TAccountState)
  lazy val _cTBillWriterState = BinaryScalaCodec(TBillWriterState)
  lazy val _cTBlockchainState = BinaryScalaCodec(TBlockchainState)
  lazy val _cTInvoiceState = BinaryScalaCodec(TInvoiceState)
  lazy val _cTNotificationState = BinaryScalaCodec(TNotificationState)
  lazy val _cTSimpleState = BinaryScalaCodec(TSimpleState)
  lazy val _cTTradingState = BinaryScalaCodec(TTradingState)
