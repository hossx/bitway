...
class MandrillMailHandler(mandrillApiKey: String)(implicit val system: ActorSystem) extends Object with Logging {
  ...
  def sendMail(to: String, template: String, params: Seq[(String, String)]) = {
